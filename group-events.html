  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-medium-slider" class="section-menu secondary">
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item" href="group-timeline.html">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="group-events.html">
          <!-- SECTION MENU ITEM ICON -->
    ...
    <div class="section-header">
      ...
      <div class="section-header-info">
        <!-- SECTION PRETITLE -->
        <p class="section-pretitle">Browse the Groups</p>
        <!-- /SECTION PRETITLE -->
