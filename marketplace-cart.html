    ...
    <div class="grid grid-9-3 small-space">
      ...
      <div class="grid-column">
            ...
            <div class="table-body same-color-rows">
              ...
              <div class="table-row medium">
                ...
                <div class="table-column padded-left">
                  ...
                  <div class="form-select">
                    <select id="product-1-license" name="product-1-license">
              ...
              <div class="table-row medium">
                ...
                <div class="table-column padded-left">
                  <!-- FORM SELECT -->
                  <div class="form-select">
                    <select id="product-2-license" name="product-2-license">
                      <option value="0">Regular</option>
                      <option value="1">Extended</option>
                    </select>
                    <!-- FORM SELECT ICON -->
              ...
              <div class="table-row medium">
                ...
                <div class="table-column padded-left">
                  <!-- FORM SELECT -->
                  <div class="form-select">
                    <select id="product-3-license" name="product-3-license">
                      <option value="0">Regular</option>
                      <option value="1">Extended</option>
                    </select>
                    <!-- FORM SELECT ICON -->
                ...
                <div class="table-column centered padded-left">
                  <!-- PRICE TITLE -->
                  <p class="price-title"><span class="currency">$</span> 26.00</p>
                  <!-- /PRICE TITLE -->
                </div>
                <!-- /TABLE COLUMN -->
        ...
        <div class="promo-line">
          <!-- PROMO LINE TEXT -->
          <p class="promo-line-text">If you have a promotional or a discount code, please enter it right here to redeem it!</p>
          <!-- /PROMO LINE TEXT -->
          ...
          <div class="promo-line-actions">
            ...
            <!-- BUTTON -->
            <p class="button secondary">Redeem Code</p>
            <!-- /BUTTON -->
          </div>
          <!-- /PROMO LINE ACTIONS -->
        </div>
      ...
      <div class="grid-column">
        ...
        <div class="sidebar-box margin-top">
          ...
          <div class="sidebar-box-items">
            ...
            <!-- BUTTON -->
            <a class="button primary" href="marketplace-checkout.html">Proceed to Checkout</a>
            <!-- /BUTTON -->
