  ...
  <div class="content-grid">
    ...
    <div class="section-header">
      ...
      <div class="section-header-info">
        ...
        <!-- SECTION TITLE -->
        <h2 class="section-title pinned">Let's discuss the current state of the Comics Cinematic Universe</h2>
        <!-- /SECTION TITLE -->
      </div>
      <!-- /SECTION HEADER INFO -->
    </div>
    ...
    <div class="grid grid-9-3">
        ...
        <div class="forum-post-list">
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-info">
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia.</p>
                <!-- /FORUM POST PARAGRAPH -->
              </div>
              <!-- /FORUM POST INFO -->
            </div>
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-meta">
              <!-- FORUM POST TIMESTAMP -->
              <p class="forum-post-timestamp">April 16, 2019 at 9:20 pm</p>
              <!-- /FORUM POST TIMESTAMP -->
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-info">
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">At vero eos et accusamus et iusto odio dignissimos ducimus qui blanditiis praesentium voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident.</p>
                <!-- /FORUM POST PARAGRAPH -->
      
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Similique sunt in culpa qui officia deserunt mollitia animi, id est laborum et dolorum fuga.</p>
                <!-- /FORUM POST PARAGRAPH -->
              </div>
              <!-- /FORUM POST INFO -->
            </div>
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-meta">
              <!-- FORUM POST TIMESTAMP -->
              <p class="forum-post-timestamp">April 18, 2019 at 5:14 pm</p>
              <!-- /FORUM POST TIMESTAMP -->
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-info">
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo.</p>
                <!-- /FORUM POST PARAGRAPH -->
              </div>
              <!-- /FORUM POST INFO -->
            </div>
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-meta">
              <!-- FORUM POST TIMESTAMP -->
              <p class="forum-post-timestamp">April 18, 2019 at 10:20 pm</p>
              <!-- /FORUM POST TIMESTAMP -->
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-info">
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam...</p>
                <!-- /FORUM POST PARAGRAPH -->
              </div>
              <!-- /FORUM POST INFO -->
            </div>
          ...
          <div class="forum-post">
            ...
            <div class="forum-post-meta">
              <!-- FORUM POST TIMESTAMP -->
              <p class="forum-post-timestamp">April 24, 2019 at 11:56 am</p>
              <!-- /FORUM POST TIMESTAMP -->
            ...
            <div class="forum-post-content">
              ...
              <div class="forum-post-info">
                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                <!-- /FORUM POST PARAGRAPH -->

                <!-- FORUM POST PARAGRAPH -->
                <p class="forum-post-paragraph">Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</p>
                <!-- /FORUM POST PARAGRAPH -->
              </div>
              <!-- /FORUM POST INFO -->
            </div>
              ...
              <div class="form-row">
                ...
                <div class="form-item">
                  ...
                  <div class="form-textarea">
                    <textarea id="forum-post-text" name="forum-post-text" placeholder="Hi Marina! Share your post here..."></textarea>
      ...
      <div class="forum-sidebar grid-column">
        ...
        <div class="stats-decoration secondary">
          ...
          <p class="stats-decoration-title">398</p>
          <!-- /STATS DECORATION TITLE -->
