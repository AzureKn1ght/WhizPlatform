      ...
      <div class="section-filters-bar v1">
        ...
        <div class="section-filters-bar-actions">
          ...
          <div class="view-actions">
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="profile-groups-list.html" data-title="List">
              <!-- VIEW ACTION ICON -->
          ...
          <div class="user-preview-info">
            ...
            <div class="user-avatar-list medium reverse centered">
              ...
              <div class="user-avatar smaller no-stats">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-30-32" data-src="img/avatar/17.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </div>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-avatar-list medium reverse centered">
              ...
              <div class="user-avatar smaller no-stats">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-30-32" data-src="img/avatar/18.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </div>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description landscape tiny">
              ...
              <a class="user-short-description-avatar user-avatar small no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-40-44" data-src="img/avatar/26.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description landscape tiny">
              ...
              <a class="user-short-description-avatar user-avatar small no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-40-44" data-src="img/avatar/30.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
