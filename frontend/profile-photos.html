  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-photos.html">
          <!-- SECTION MENU ITEM ICON -->
    ...
    <section class="section">
      ...
      <div class="section-header">
        ...
        <div class="section-header-info">
          <!-- SECTION PRETITLE -->
          <p class="section-pretitle">Check Marina's</p>
          <!-- /SECTION PRETITLE -->
        ...
        <div class="section-header-actions">
          <!-- SECTION HEADER ACTION -->
          <p class="section-header-action">Upload Photos +</p>
          <!-- /SECTION HEADER ACTION -->
      ...
      <div class="photos-masonry">
        <!-- PHOTO PREVIEW -->
        <div class="photo-preview popup-picture-trigger">
          <!-- PHOTO PREVIEW IMAGE -->
        ...
        <div class="upload-item-list">
          ...
          <div class="upload-item">
            ...
            <figure class="upload-item-image liquid">
              <img src="img/cover/23.jpg" alt="upload-item-23">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
          ...
          <div class="upload-item">
            <!-- UPLOAD ITEM IMAGE -->
            <figure class="upload-item-image liquid">
              <img src="img/cover/32.jpg" alt="upload-item-32">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
          ...
          <div class="upload-item">
            <!-- UPLOAD ITEM IMAGE -->
            <figure class="upload-item-image liquid">
              <img src="img/cover/36.jpg" alt="upload-item-36">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
          ...
          <div class="upload-item">
            <!-- UPLOAD ITEM IMAGE -->
            <figure class="upload-item-image liquid">
              <img src="img/cover/38.jpg" alt="upload-item-38">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
          ...
          <div class="upload-item">
            <!-- UPLOAD ITEM IMAGE -->
            <figure class="upload-item-image liquid">
              <img src="img/cover/37.jpg" alt="upload-item-37">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
          ...
          <div class="upload-item">
            <!-- UPLOAD ITEM IMAGE -->
            <figure class="upload-item-image liquid">
              <img src="img/cover/39.jpg" alt="upload-item-39">
            </figure>
            <!-- /UPLOAD ITEM IMAGE -->
