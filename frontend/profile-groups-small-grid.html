  ...
  <div class="content-grid">
    ...
    <nav class="section-navigation">
      ...
      <div id="section-navigation-slider" class="section-menu">
        ...
        <!-- SECTION MENU ITEM -->
        <a class="section-menu-item active" href="profile-groups.html">
          <!-- SECTION MENU ITEM ICON -->
      ...
      <div class="section-filters-bar v1">
        ...
        <div class="section-filters-bar-actions">
          ...
          <div class="view-actions">
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="profile-groups.html" data-title="Big Grid">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="profile-groups-small-grid.html" data-title="Small Grid">
              <!-- VIEW ACTION ICON -->
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <a class="user-short-description-avatar user-avatar no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-84-92" data-src="img/avatar/29.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <a class="user-short-description-avatar user-avatar no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-84-92" data-src="img/avatar/25.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <a class="user-short-description-avatar user-avatar no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-84-92" data-src="img/avatar/27.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <a class="user-short-description-avatar user-avatar no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-84-92" data-src="img/avatar/26.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
          ...
          <div class="user-preview-info">
            ...
            <div class="user-short-description small">
              ...
              <a class="user-short-description-avatar user-avatar no-stats" href="group-timeline.html">
                ...
                <div class="user-avatar-content">
                  <!-- HEXAGON -->
                  <div class="hexagon-image-84-92" data-src="img/avatar/30.jpg"></div>
                  <!-- /HEXAGON -->
                </div>
                <!-- /USER AVATAR CONTENT -->
              </a>
