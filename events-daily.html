    ...
    <div class="calendar-widget">
      ...
      <div class="calendar-widget-header">
        ...
        <div class="calendar-widget-header-actions">
          ...
          <p class="calendar-widget-title">Monday, August 13th</p>
          <!-- /CALENDAR WIDGET TITLE -->
        </div>
        <!-- /CALENDAR WIDGET HEADER ACTIONS -->
        ...
        <div class="calendar-widget-header-actions">
          ...
          <div class="view-actions">
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="events-daily.html" data-title="Daily">
              <!-- VIEW ACTION ICON -->
      ...
      <div class="calendar-daily">
        ...
        <div class="calendar-daily-body-wrap" data-simplebar>
          <!-- CALENDAR DAILY BODY -->
          <div class="calendar-daily-body">
            <!-- CALENDAR DAILY HOURS -->
            <div class="calendar-daily-hours">
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">8 AM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">9 AM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">10 AM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">11 AM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">12 PM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">1 PM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">2 PM</p>
              <!-- /CALENDAR DAILY HOUR -->
    
              <!-- CALENDAR DAILY HOUR -->
              <p class="calendar-daily-hour">3 PM</p>
              <!-- /CALENDAR DAILY HOUR -->
            </div>
            <!-- /CALENDAR DAILY HOURS -->
    
            <!-- CALENDAR WEEKLY INTERVALS -->
            <div class="calendar-daily-intervals">
              <!-- CALENDAR DAILY INTERVAL -->
              <div class="calendar-daily-interval">
                <!-- CALENDAR DAILY INTERVAL PART -->
                <div class="calendar-daily-interval-part"></div>
                <!-- /CALENDAR DAILY INTERVAL PART -->
    
                <!-- CALENDAR DAILY INTERVAL PART -->
                <div class="calendar-daily-interval-part">
                  <!-- CALENDAR DAILY EVENT -->
                  <p class="calendar-daily-event secondary popup-event-information-trigger">Breakfast with Neko</p>
                  <!-- /CALENDAR DAILY EVENT -->
                </div>
                <!-- /CALENDAR DAILY INTERVAL PART -->
              </div>
              ...
              <div class="calendar-daily-interval">
                ...
                <div class="calendar-daily-interval-part">
                  <!-- CALENDAR DAILY EVENT -->
                  <p class="calendar-daily-event primary span-3 popup-event-information-trigger">Streaming Party</p>
                  <!-- /CALENDAR DAILY EVENT -->
                </div>
                <!-- /CALENDAR DAILY INTERVAL PART -->
