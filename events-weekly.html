    ...
    <div class="calendar-widget">
      ...
      <div class="calendar-widget-header">
        ...
        <div class="calendar-widget-header-actions">
          ...
          <p class="calendar-widget-title">12 August - 18 August</p>
          <!-- /CALENDAR WIDGET TITLE -->
        </div>
        <!-- /CALENDAR WIDGET HEADER ACTIONS -->
        ...
        <div class="calendar-widget-header-actions">
          ...
          <div class="view-actions">
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium" href="events.html" data-title="Monthly">
              <!-- VIEW ACTION ICON -->
            ...
            <!-- VIEW ACTION -->
            <a class="view-action text-tooltip-tft-medium active" href="events-weekly.html" data-title="Weekly">
              <!-- VIEW ACTION ICON -->
      ...
      <div class="calendar-weekly">
        ...
        <div class="calendar-weekly-week">
          <!-- CALENDAR WEEKLY WEEK DAY -->
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Sun</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">12</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
    
          <!-- CALENDAR WEEKLY WEEK DAY -->
          <div class="calendar-weekly-week-day active">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Mon</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">13</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
          ...
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Tue</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">14</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
          ...
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Wed</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">15</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
          ...
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Thu</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">16</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
          ...
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Fri</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">17</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
          ...
          <div class="calendar-weekly-week-day">
            <!-- CALENDAR WEEKLY WEEK DAY TEXT -->
            <p class="calendar-weekly-week-day-text">Sat</p>
            <!-- /CALENDAR WEEKLY WEEK DAY TEXT -->
    
            <!-- CALENDAR WEEKLY WEEK DAY NUMBER -->
            <p class="calendar-weekly-week-day-number">18</p>
            <!-- /CALENDAR WEEKLY WEEK DAY NUMBER -->
          </div>
          <!-- /CALENDAR WEEKLY WEEK DAY -->
        </div>
        ...
        <div class="calendar-weekly-body-wrap" data-simplebar>
          <!-- CALENDAR WEEKLY BODY -->
          <div class="calendar-weekly-body">
            <!-- CALENDAR WEEKLY HOURS -->
            <div class="calendar-weekly-hours">
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">8 AM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">9 AM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">10 AM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">11 AM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">12 PM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">1 PM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">2 PM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
    
              <!-- CALENDAR WEEKLY HOUR -->
              <p class="calendar-weekly-hour">3 PM</p>
              <!-- /CALENDAR WEEKLY HOUR -->
            </div>
            <!-- /CALENDAR WEEKLY HOURS -->
            ...
            <div class="calendar-weekly-days">
              ...
              <div class="calendar-weekly-day-column">
                <!-- CALENDAR WEEKLY DAY INTERVAL -->
                <div class="calendar-weekly-day-interval">
                  <!-- CALENDAR WEEKLY DAY PART -->
                  <div class="calendar-weekly-day-part"></div>
                  <!-- /CALENDAR WEEKLY DAY PART -->
              ...
              <!-- CALENDAR WEEKLY DAY COLUMN -->
              <div class="calendar-weekly-day-column active">
                <!-- CALENDAR WEEKLY DAY INTERVAL -->
                <div class="calendar-weekly-day-interval">
                  <!-- CALENDAR WEEKLY DAY PART -->
                  <div class="calendar-weekly-day-part"></div>
                  ...
                  <!-- CALENDAR WEEKLY DAY PART -->
                  <div class="calendar-weekly-day-part">
                    <!-- CALENDAR WEEKLY DAY EVENT -->
                    <p class="calendar-weekly-day-event secondary popup-event-information-trigger">Breakfast with Neko</p>
                    <!-- /CALENDAR WEEKLY DAY EVENT -->
                  </div>
                  <!-- /CALENDAR WEEKLY DAY PART -->
                </div>
                ...
                <div class="calendar-weekly-day-interval">
                  ...
                  <div class="calendar-weekly-day-part">
                    <!-- CALENDAR WEEKLY DAY EVENT -->
                    <p class="calendar-weekly-day-event span-3 primary popup-event-information-trigger">Streaming Party</p>
                    <!-- /CALENDAR WEEKLY DAY EVENT -->
                  </div>
                  <!-- /CALENDAR WEEKLY DAY PART -->
